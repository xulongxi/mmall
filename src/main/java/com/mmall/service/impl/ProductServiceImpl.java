 ...
 * 创建时间： 2017/11/20 15:15
 *
 * @author Longxi XU
 * 描述：     ViewObject或者ValueObject
 */
...
public class ProductServiceImpl implements IProductService {
    ...
    @Override
    public ServerResponse<PageInfo> searchProductByNameOrId(String productName, Integer productId, Integer pageNum, Integer pageSize) {
        //startPage--开始
        //填充自己的sql查询语句
        //pageHelper--收尾
        PageHelper.startPage(pageNum, pageSize);
